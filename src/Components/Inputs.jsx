  ...
  return (
    <div className="flex flex-row justify-center my-6">
      <div className="flex flex-row w-4/5 items-center justify-center space-x-4">
        ...
        <input placeholder='Search a city' className="text-xl font-light p-2 w-full shadow-xl capitalize placeholder:capitalize focus: outline-none " value={city} onChange={(e)=> setCity(e.target.value)}/>
